...
def projects_index():
    ...
    <header class="hero">
      ...
      <p class="lede">
        ...
        hold only ciphertext for the fields that matter.
      </p>
      <p>
        Each one seals the sensitive fields before they reach the database and opens them only for a
        user a quorum granted the reading role. The same pattern works across
        <strong>Node, Ruby, PHP and Python</strong>, and every fork is off unless it's configured,
        so an unconfigured checkout behaves exactly like upstream.
      </p>
    </header>
